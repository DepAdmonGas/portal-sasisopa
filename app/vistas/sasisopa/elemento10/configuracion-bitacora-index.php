...
<html lang="es">
  ...
  $('#ListaPersonalRDP').load('app/vistas/sasisopa/elemento10/lista-personal-autorizado.php?Categoria=RDP');  
  }

  function ListaPersonalMPC(){
  $('#ListaPersonalMPC').load('app/vistas/sasisopa/elemento10/lista-personal-autorizado.php?Categoria=MPC');  
  }

  function BTNRecepcion(){
  $('#ModalAgregar').modal('show'); 
  $('#ContenidoModal').load('app/vistas/sasisopa/elemento10/modal-acceso-recepcion.php');
  }
  ...
  function FirmaBitacora(categoria){
    ...
    $('#idUsuario').css('border','');  
      ...
      var parametros = {
      "accion" : "agregar-acceso-trabajador",
      "idUsuario" : idUsuario,
      "categoria" : categoria
      };
  ...
  $('#ModalAgregar').modal('show'); 
  $('#ContenidoModal').load('app/vistas/sasisopa/elemento10/modal-detalle-personal-autorizado.php?idFirma=' + idFirma);
  }
...
var parametros = {
    "accion" : "eliminar-firma-personal",
    "idFirma": idFirma,

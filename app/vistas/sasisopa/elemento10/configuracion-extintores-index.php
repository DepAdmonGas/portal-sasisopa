...
<html lang="es">
  ...
  $('#DivContenido').load('app/vistas/sasisopa/elemento10/lista-extintores.php');
  }
...
function LimpiarCampos(){
  ...
  $('#DivEditar').load('app/vistas/sasisopa/elemento10/modal-editar-extintores.php?idExtintor=' + id);
  }

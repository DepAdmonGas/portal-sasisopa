...
<html lang="es">
  ...
  $('#ListaTanques').load('app/vistas/sasisopa/elemento10/lista-tanques.php');
  }
...
var parametros = {
     "accion" : "agregar-tanque-almacenamiento",
      "NoTanque" : NoTanque,
       "Capacidad" : Capacidad,
       "Producto" : Producto
    };
...
$('#NoTanque').css('border','2px solid #A52525');
  ...
  function Eliminar(id){
    var parametros = {
    "accion" : "eliminar-tanque-almacenamiento",
      "idTanque" : id
    };
...
function(){
  ...
  $('#DivEditar').load('app/vistas/sasisopa/elemento10/modal-editar-tanque-almacenamiento.php?idTanque=' + id);
  }
...
if (EditProducto != "") {
        ...
        var parametros = {
          "accion" : "editar-tanque-almacenamiento",
        "idTanque" : id,

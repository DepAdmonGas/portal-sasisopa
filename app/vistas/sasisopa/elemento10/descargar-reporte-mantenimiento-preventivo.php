...
if ($idequipo == 44) {
        ...
        $type = pathinfo($row_imagen1['imagen_firma'], PATHINFO_EXTENSION);
        ...
        $type = pathinfo($row_imagen2['imagen_firma'], PATHINFO_EXTENSION);
        ...
        $type = pathinfo($row_tirilla['imagen_tirilla'], PATHINFO_EXTENSION);

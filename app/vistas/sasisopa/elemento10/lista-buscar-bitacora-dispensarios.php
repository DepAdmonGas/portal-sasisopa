...
<div class="text-right mb-2">
 ...
 <a download href="app/vistas/sasisopa/elemento10/reporte-excel-bitacora-dispensario-buscar.php?Year=<?=$selyear;?>&Mes=<?=$MesPDF;?>" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Excel" >
    <img src="<?php echo RUTA_IMG_ICONOS."excel.png"; ?>">
    </a>

 <a onclick="ListaDispensario(1)" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Regresar" >

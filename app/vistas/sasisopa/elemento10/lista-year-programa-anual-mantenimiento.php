...
$sql_programa = "SELECT id,year,estado FROM po_programa_anual_mantenimiento WHERE id_estacion = '".$idEstacion."' ";
...
<button type='button' class='btn btn-success btn-sm' onclick='ProgramaNew(".$fecha_year.")'>Crear nuevo programa de mantenimiento</button>
</div>";
}
?>
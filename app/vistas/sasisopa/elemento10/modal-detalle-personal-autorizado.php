...
$sql_usuarios = "SELECT tb_usuarios.id, tb_usuarios.nombre, tb_usuarios.id_puesto, tb_usuarios.id_gas, tb_usuarios_firma_bitacora.id AS idFirma, 
tb_usuarios_firma_bitacora.categoria, tb_usuarios_firma_bitacora.fechainicio, tb_usuarios_firma_bitacora.fechatermino, 
tb_usuarios_firma_bitacora.comentario, tb_usuarios_firma_bitacora.estado, tb_puestos.tipo_puesto

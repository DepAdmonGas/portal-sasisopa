...
<html lang="es">
  ...
  function ListaAuditoria(){
     ...
     $.ajax({
     url:   'app/vistas/sasisopa/elemento15/buscar-lista-auditoria-interna.php',
     type:  'post',
     beforeSend: function() {
     },
     complete: function(){
...
var parametros = {
    "accion" : "agregar-auditoria-interna",
...
data.append('accion', 'agregar-archivo-interna-formato24');
...
data.append('accion', 'agregar-archivo-interna-formato25');
data.append('idDocumento', id);
data.append('ArchivoPdf_file', ArchivoPdf_file);
...
function ModalAnexo(id,formato){
  $('#ModalDetalle').modal('show');
  $('#ContenidoDetalle').load('app/vistas/sasisopa/elemento15/modal-auditoria-interna-anexos.php?id=' + id + '&formato=' + formato);
}
...
function BtnGuardar(id,formato){
  ...
  let url = 'app/controlador/AuditoriaControlador.php';
  ...
  $('#ArchivoPdf').css('border','');
    ...
    data.append('accion', 'agregar-anexo-auditoria-interna');
    data.append('id', id);

...
window.location.href = 'auditoria-externa';   
  ...
  <body>
    ...
    <div class="text-right mt-4"><button type="button" class="btn btn-primary btn-sm" style="border-radius: 0px;" onclick="BTNPrograma()" >Ver programa de auditorias</button></div>
    </div>
    </div>
    </div>
    ...
    <div class="text-right mt-4" style="margin-top: 10px;"><button type="button" class="btn btn-primary btn-sm" style="border-radius: 0px;" onclick="BTNAuditoriaI()" >Ver auditoria interna </button></div>
    </div>
    </div>
    </div>
    ...
    <div class="text-right mt-4"><button type="button" class="btn btn-primary btn-sm" style="border-radius: 0px;" onclick="BTNAuditoriaE()" >Ver auditoria externa</button></div>
    </div>  
    </div>
    </div>

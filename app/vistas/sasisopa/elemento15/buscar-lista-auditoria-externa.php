...
echo "<td class='text-center align-middle' id='td3".$id."'>".$row_auditoria['prestador_servicio']."</td>";
...
echo "<td class='text-center align-middle' id='td10".$id."'><a class='c-pointer' onclick='Asea(".$id.")'><img src='".RUTA_IMG_ICONOS."asea.png'></a></td>";
echo "</tr>";

...
$sql_resultado = "SELECT * FROM tb_revision_resultados WHERE id_estacion = '".$Session_IDEstacion."' ORDER BY fecha_hora desc";
...
<table class="table table-bordered table-striped table-sm table-hover mt-2 mb-0 pb-0">
	<thead>
		<tr>
...
if($row_resultado['archivo'] != ""){
	...
	$imgPDF = "<img src='".RUTA_IMG_ICONOS."eliminar-red-16.png'>";
		...
		echo "<td class='text-center align-middle' width='20px' style='cursor: pointer;'><img src='".RUTA_IMG_ICONOS."edit-black-16.png' onclick='ModalEditar(".$id.")'></td>";

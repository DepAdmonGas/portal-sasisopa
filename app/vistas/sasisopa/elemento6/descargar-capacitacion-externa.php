...
$sql_capacitacion = "SELECT * FROM tb_capacitacion_externa WHERE id = '".$GET_idRegistro."' ";
...
$sql = "SELECT * FROM tb_capacitacion_externa_personal WHERE id_capacitacion = '".$GET_idRegistro."' ";
...
$personal = $class_personal->buscarPersonal($row['id_empleado']);

$contenid0 .= '<tr>';
$contenid0 .= '<td class="align-middle text-center">'.$i.'</td>';
$contenid0 .= '<td class="align-middle">'.$personal['nombre'].'</td>';

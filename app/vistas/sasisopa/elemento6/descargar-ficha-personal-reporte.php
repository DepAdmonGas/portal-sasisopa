...
$sql_usuarios = "SELECT id,nombre,fecha_nacimiento,estado_civil,seguro_social,domicilio,telefono,email,usuario,password,id_puesto FROM tb_usuarios WHERE id_gas = '".$Session_IDEstacion."' AND estatus = 0 ";
...
<tr>
  ...
  $sql_e_grupo = "SELECT id,razon_social,puesto,periodo_inicio,periodo_fin FROM tb_usuarios_experiencia_empresa_grupo WHERE id_usuario = '".$GET_idUsuario."' ";
...
$dompdf->stream('Reporte completo de Fichas de personal.pdf');
//------------------
mysqli_close($con);
//------------------
...
usuario,
password,
id_puesto FROM tb_usuarios WHERE id = '".$GET_idUsuario."' ";
...
//--------------------------------------------------------------------------------------------------------
$contenid0 .= '<div style="margin-top: 10px;margin-bottom: 10px;"><b>1. Datos personales:</b></div>';

$contenid0 .= '<div style="border-bottom: .9px solid #E6E6E6;padding-bottom: 5px;font-size: .8em">'.$nombres.'</div>';
$contenid0 .= '<div style="color: #A4A4A4;">Nombre completo:</div>';
...
//----------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------
$contenid0 .= '<div style="margin-top: 10px;margin-bottom: 10px;"><b>2. Datos de familiares</b></div>';
...
<td><b>Teléfono:</b></td>
  ...
  $sql_d_familiares = "SELECT id,nombrecompleto,parentesco,domicilio,telefono FROM tb_usuarios_familiares WHERE id_usuario = '".$GET_idUsuario."' ";
...
//---------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------
$contenid0 .= '<div style="margin-top: 10px;margin-bottom: 10px;"><b>3. Formación académica</b></div>';
...
$contenid0 .= '<tr>
  ...
  $sql_f_academica = "SELECT id,nivel,detalle FROM tb_usuarios_formacion_academica WHERE id_usuario = '".$GET_idUsuario."' ";
...
//---------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------
$contenid0 .= '<div style="margin-top: 10px;margin-bottom: 10px;"><b>4. Experiencia laboral</b></div>';
$contenid0 .= '<div style="margin-top: 10px;margin-bottom: 10px;"><b>4.1 En otras empresas </b></div>';

$contenid0 .= '<table class="table table-bordered" style="font-size: .8em">';
$contenid0 .= '<tbody>';

  $sql_e_laboral = "SELECT id,detalle FROM tb_usuarios_experiencia_laboral WHERE id_usuario = '".$GET_idUsuario."' ";
...
//----------------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------------
$contenid0 .= '<div style="margin-top: 10px;margin-bottom: 10px;"><b>4.2 En la empresa </b></div>';

...
$title = 'Pendiente';
$eliminar = '<a style="cursor: pointer;" data-toggle="tooltip" data-placement="right" title="Eliminar"><img class="grayscale" src="'.RUTA_IMG_ICONOS.'eliminar.png" onclick="Eliminar('.$id.','.$idModulo.','.$idTema.','.$idUsuario.')"></a>';

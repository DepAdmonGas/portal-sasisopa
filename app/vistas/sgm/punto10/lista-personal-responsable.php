...
?>
              ...
              <select class="form-control rounded-0 rounded-0" onchange="AgregarPersonalResponsable(this,<?=$_GET['id'];?>,13)">
...
<?php
$sql = "SELECT * FROM sgm_plan_auditoria_responsable WHERE id_plan = '".$_GET['id']."' ";
$result = mysqli_query($con, $sql);
$numero = mysqli_num_rows($result);
...
<img src="'.RUTA_IMG_ICONOS.'eliminar.png" style="cursor: pointer;" onclick="Eliminar(0,'.$_GET['id'].','.$row['id'].',14)">
</li>';
}
echo '</ul>';
?>
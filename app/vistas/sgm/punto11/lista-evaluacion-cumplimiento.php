...
$sql_capacitacion = "SELECT * FROM sgm_cumplimiento_objetivos_revision WHERE id_estacion = '".$Session_IDEstacion."' ORDER BY id DESC ";
...
echo "<td class='text-center align-middle' width='30'><img src='".RUTA_IMG_ICONOS."editar.png' style='cursor: pointer;' onclick='modalEditar(".$id.")'></td>";
echo "<td class='text-center align-middle' width='30'><img src='".RUTA_IMG_ICONOS."pdf.png' style='cursor: pointer;' onclick='Descargar(".$id.")'></td>";

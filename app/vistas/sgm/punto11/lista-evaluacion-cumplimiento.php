...
?>
<table class="table table-bordered table-striped table-sm" id="table-evaluacion-cumplimiento-orpd">
<thead>	
...
echo '<td class="text-center align-middle" width="20px" style="cursor: pointer;">
  ...
  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
    ...
    <a class="dropdown-item" onclick="Descargar('.$id.')"><i class="fa-regular fa-file-pdf"></i> Descargar PDF</a>
  </div>
  </div>
  </td>';

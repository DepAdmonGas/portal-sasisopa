...
<html lang="es">
  ...
  $('#ListaCapacitacion').load('app/vistas/sgm/punto6/lista-programa-anual-capacitacion-interna.php');
  }
  ...
  function btnDescargar(){
    window.location = "descargar-programa-anual-capacitacion-interna-sgm";
  }
  </script>
  </head>
  <body>
  ...
  <div class="LoaderPage"></div>
    ...
    <div class="float-left"><h4>Programa Capacitacion Interna</h4></div>

...
$contenid0 .= '<div>';
      ...
      $contenid0 .= '</td>';
      $contenid0 .= '<td class="align-middle text-center" rowspan="2">';
      $contenid0 .= '<b>Capacitación de inducción</b>';
      $contenid0 .= '</td>';
...
$contenid0 .= "<td class='align-middle'>".FormatoFecha($usuario['fecha_ingreso'])."</td>";
$contenid0 .= "<td class='align-middle'>".$row['titulo']."</td>";
$contenid0 .= "<td class='text-center align-middle'>Interno</td>";
...
$dompdf->stream('Capacitación de inducción.pdf');

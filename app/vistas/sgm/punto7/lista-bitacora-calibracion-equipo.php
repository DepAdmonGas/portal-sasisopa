...
$Detalle = '<a class="dropdown-item disabled"><i class="fa-regular fa-eye"></i> Detalle PDF</a>';
...
$Editar = '<a class="dropdown-item" onclick="Editar('.$row['id'].')"><i class="fa-regular fa-pen-to-square"></i> Editar</a>';
$Detalle = '<a class="dropdown-item" onclick="Detalle('.$row['id'].')"><i class="fa-regular fa-eye"></i> Detalle PDF</a>';
...
<table class="table table-bordered table-sm mb-0" id="table-bitacora-calibracion-equipos">
<thead>

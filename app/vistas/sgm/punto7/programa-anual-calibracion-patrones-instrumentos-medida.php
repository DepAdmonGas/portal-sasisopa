...
<html lang="es">
  ...
  <body>
    ...
    <div class="float-left"><h4>Programa anual de calibración de patrones e instrumentos de medida</h4></div>
    <div class="float-right">

     <a class="mr-2" onclick="modalBuscar(14)" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Buscar" >
    <img src="<?php echo RUTA_IMG_ICONOS."buscar-icono.png"; ?>">
    </a> 

    <a class="" onclick="modalNuevo(<?=$fecha_year;?>,14)" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Agregar" >

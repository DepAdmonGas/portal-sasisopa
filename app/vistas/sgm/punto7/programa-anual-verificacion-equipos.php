 ...
 $.ajax({
  ...
  <body>
    ...
    <div class="magir-top-principal p-3">
      ...
      <li onclick="modalBuscar(15)"><a class="dropdown-item c-pointer"> <i class="fa-solid fa-magnifying-glass"></i> Buscar</a></li>
      </ul>
      </div>
      </div>
      <!-- Fin -->
      ...
      <li aria-current="page" class="breadcrumb-item active">Programa anual de verificación de equipos</li>
      </ol>
      </div>
      <!-- Fin -->

      <h3>Programa anual de verificación de equipos</h3>

      <div class="bg-white mt-3 p-3"><div id="ListaProgramaAnual"></div></div>

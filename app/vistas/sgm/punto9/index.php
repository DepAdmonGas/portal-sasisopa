...
<html lang="es">
 ...
 ListaAsistencia(109);
  ...
  <body>
    ...
    <div class="float-left"><h4>9. Establecimiento y Seguimiento Confirmación Metrológica</h4></div>
    ...
    <div class="card-body">
        ...
        <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 mt-2 mb-2">
            ...
            <div class="col-2">
            <a class="float-right" onclick="btnListaAsistencia(109,2)" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Crear" >

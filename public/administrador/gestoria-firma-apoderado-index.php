...
<html lang="es">
  ...
  function regresarP(){
   ...
   $('#FirmaUsuario').load('public/gerente/vistas/firma-personal.php?idUsuario=22'); 
  }
  ...
  <body>
    ...
    <div class="float-left"><h4>FIRMA APODERADO LEGAL</h4></div>
    ...
    <div class="card-body">
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">  
        <div class="border p-3">
          ...
          <canvas style="width: 100%; height: 140px; border: 1px black solid;" id="canvas"></canvas>
          </div>
          <input type="hidden" name="base64" value="" id="base64">
          </div> 
          <div class="text-right mt-2">
          <button type="button" class="btn btn-danger btn-sm" onclick="resizeCanvas()">Limpiar</button>
          <button type="button" class="btn btn-primary btn-sm" onclick="Guardar(22)">Guardar</button>
          </div>

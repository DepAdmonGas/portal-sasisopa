...
<html lang="es">
  ...
  window.location.href = '../administrador-sasisopa';
   ...
   function ListaProgramaAnual(){
    $('#DivListaPrograma').load('../public/administrador/vistas/lista-year-programa-anual-mantenimiento.php?idEstacion=<?=$idEstacion;?>');    
  } 

function DetallePrograma(id){
$('#DivListaPrograma').load('../public/administrador/vistas/detalle-programa-anual-mantenimiento.php?idReporte=' + id + '&idEstacion=<?=$idEstacion;?>'); 
}

function Descargar(id,idestacion){
  window.location = "../descargar-programa-anual-mantenimiento/" + id + '/' + idestacion;  
  }
  ...
  <div class="LoaderPage"></div>
    ...
    <div class="float-left"><h4><?=$estacion;?> (Programa Anual de Mantenimiento)</h4></div>
    </div>
    <div class="card-body">

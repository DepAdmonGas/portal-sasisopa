...
$sql_usuarios = "SELECT * FROM tb_usuarios WHERE id_gas = '".$idEstacion."' and bitacora_app = 1 and estatus = 0 ";
...
echo "<td class='text-center align-middle' width='30'><img src='".RUTA_IMG_ICONOS."eliminar-red-16.png' style='cursor: pointer;' data-toggle='tooltip' data-placement='left' title='Eliminar usuario' onclick='EliminarPB(".$idusuario.")'></td>";
echo "</tr>";
}
?>
</tbody>

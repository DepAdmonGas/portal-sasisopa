...
<div class="card" style="border-radius: 0px;cursor: pointer" onclick="DetallePrograma(<?=$idreporte;?>)">
<div class="card-body">
...
<div class='pb-3'><small class='text-secondary'>No se encontro informacion para mostrar</small></div>
</div>";
}
?>
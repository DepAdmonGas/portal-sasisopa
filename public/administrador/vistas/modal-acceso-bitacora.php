...
<div class="modal-header">
	<h4 class="modal-title">Agregar acceso a la aplicación Bitácora</h4>
...
<button type="button" class="btn btn-primary rounded-0" onclick="AccesoAplicacion()">Guardar</button>
</div>

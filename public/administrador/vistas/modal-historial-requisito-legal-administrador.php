...
<button type="button" class="btn btn-primary btn-sm rounded-0" onclick="NuevoRequisito(<?=$idre;?>,<?=$idUsuario;?>, <?=$Estacion;?>)">Nuevo</button>
</div>
...
echo "<td class='text-center align-middle'width='20px' style='cursor: pointer;'><img src='".RUTA_IMG_ICONOS."edit-black-16.png' onclick='editararchivo(".$idre.",".$idmatriz.",".$idUsuario.")'></td>";

echo "<td class='text-center align-middle'width='20px' style='cursor: pointer;'><img src='".RUTA_IMG_ICONOS."img-no.png' onclick='EliminarArchivo(".$idre.",".$idmatriz.",".$idUsuario.", ".$Estacion.")'></td>";
echo "</tr>";
}
}else{

...
//---------------------------------------------------------
$Pregunta10 = explode(",", $_POST['respuesta10']);

$Usuario10 = $Pregunta10[0];
$Respuesta10 = $Pregunta10[1];
$Resultado10 = $Pregunta10[2];
//---------------------------------------------------------
$Totpreguntas =  10;
$porcentaje   =  $Totpreguntas * 10;
$resultado = $Resultado1 + $Resultado2 + $Resultado3 + $Resultado4 + $Resultado5 + $Resultado6 + $Resultado7 + $Resultado8 + $Resultado9 + $Resultado10;   
...
//------------- Pregunta 5
$sql_pregunta_10 = "INSERT INTO cu_evaluacion_modulos_preguntas (id_evaluacion_modulo_detalle, pregunta, respuesta_correcta, respuesta_usuario, resultado )
VALUES ('".$id."','".$_POST['Titulo10']."', '".$Respuesta10."', '".$Usuario10."', '".$Resultado10."')";
mysqli_query($con, $sql_pregunta_10);

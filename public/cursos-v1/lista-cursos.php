...
<div class="" style="padding: 10px;" >
  ...
  <h5 data-toggle="tooltip" data-placement="top" title="<?php echo $row['tema']; ?>">
    <?php echo $row['tema']; ?>
  </h5>
  ...
  <div align="right">
    <button type="button" class="btn btn-outline-success btn-sm mt-3" onclick="BTNverModulos(<?php echo $temaid; ?>)" <?php echo $disabled; ?> >Ver Módulos</button>
  </div>
...
$sql_tema = "SELECT * FROM cu_temas ";
$query_tema = mysqli_query($con, $sql_tema);
while($row = mysqli_fetch_array($query_tema, MYSQLI_ASSOC)){
...
echo '<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mt-2 mb-2 ">';
echo '<div class="" style="padding: 10px;" >';
echo '<div class="card-cursos-float">';
echo '<div class="card card-cursos-home" >';
echo '<div class="card-body text-center">';  
echo '<h5 data-toggle="tooltip" data-placement="top" title="'.$row['tema'].'">';
echo $row['tema'];
echo '</h5>';
echo '<div><a><a style="color: #1BB05F;font-size: 3.5em;font-weight: bold">'.$numero_modulos.'</a> <a class="text-muted" style="font-size: .9em;">Módulos</a></a></div>';
  
echo '<div align="right"><button type="button" class="btn btn-outline-success btn-sm mt-3" onclick="BTNverModulos('.$temaid.')" >Ver Módulos</button></div>';

...
WHERE YEAR(tb_cursos_calendario.fecha_programada) = '".$GET_idYear."' AND 
tb_cursos_modulos.num_modulo = '".$GET_idModulo."' AND 
tb_cursos_calendario.id_estacion = '".$Session_IDEstacion."' AND 
tb_cursos_calendario.resultado >= 60 ORDER BY tb_cursos_calendario.fecha_programada DESC ";

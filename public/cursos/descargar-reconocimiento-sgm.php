...
$pdf->Image('public/cursos/fondo-sgm.jpg','0','0','300','210','JPG');

$pdf->SetFont('Arial','',24);
$pdf->SetY(107);
$pdf->CELL(290,0,utf8_decode($NomUsuario),0,0,'C');
$pdf->Ln(29);

$pdf->SetFont('Arial','',17);
$pdf->SetX(24);
$pdf->MULTICELL(0,0,utf8_decode($titulo.$Observacion),0,'C');
$pdf->Ln(28);

$pdf->SetFont('Arial','',12);
$pdf->SetX(73);
$pdf->CELL(0,0,FormatoFecha($fecha),0,0);

if(isset($Session_ApoderadoLegalFirma)){
  $extension = pathinfo($Session_ApoderadoLegalFirma, PATHINFO_EXTENSION);
  $pdf->Image(RUTA_IMG_FIRMA_PERSONAL.$Session_ApoderadoLegalFirma,'175','151','50','0',$extension);
}

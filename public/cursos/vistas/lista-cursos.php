...
?>
  ...
  <div class="card card-menuB rounded shadow-sm p-3 mb-2">
    ...
    <div class="d-flex justify-content-between">
      ...
      <a class="color-disabled" style="font-weight: bold;"><?=$num_modulo;?></a> 
      </div>

      </div>

      <div> <span class="badge rounded-pill bg-disabled float-end mb-sm-0 mt-3">
    ...
    <div>
    <button class="btn btn-sm btn-primary float-end" type="button" onclick="detalleModulo(<?=$GET_idModulo?>)">Ver Temas</button>
    </div>

                          ...
                          if (Po3_VoV != "") {
                            if (Po3_VoF != "") {
                              ...
                              alertify.confirm('',
                                ...
                                function() {}).setHeader('Agregar Reporte').set({
                                transition: 'zoom',
                                message: 'Desea agregar la siguiente información de la estación',
                                labels: {
                                  ok: 'Aceptar',
                                  cancel: 'Cancelar'
                                }
  ...
  <div class="magir-top-principal p-3">
    ...
    <div class="float-end">
      <div class="dropdown dropdown-sm d-inline ms-2">
        <button type="button" class="btn btn-primary" type="button" id="dropdownMenuButton1" aria-expanded="false" onclick="BTNFinalizar()">
    ...
    <!-- Fin -->
    <h3>AGREGAR REPORTE ESTADÍSTICO DE LA CRE</h3>

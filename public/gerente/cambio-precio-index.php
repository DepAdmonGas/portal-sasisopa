...
<html lang="es">
  ...
  $('#DivPrecios').load('public/gerente/vistas/lista-cambio-precios.php'); 
  }
...
function(){
}).setHeader('Eliminar cambio de precio').set({transition:'zoom',message: 'Desea eliminar el cambio de precio',labels:{ok:'Aceptar', cancel: 'Cancelar'}}).show();

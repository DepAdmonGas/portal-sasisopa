    ...
    function EditFecha() {
      ...
      if (FechaNew != "") {
        ...
        alertify.confirm('',
          ...
          function() {}).setHeader('Editar fecha').set({
          transition: 'zoom',
          message: 'Desea editar la fecha del reporte',
          labels: {
            ok: 'Aceptar',
            cancel: 'Cancelar'
          }
...
<body>
  ...
  <div class="magir-top-principal p-3">
    ...
    <div class="float-end">
      <div class="dropdown dropdown-sm d-inline ms-2">
        ...
        <ul class="dropdown-menu">
          <li onclick="editarfecha()"><a class="dropdown-item c-pointer"> <i class="fa-regular fa-pen-to-square"></i> Editar Fecha</a></li>
        </ul>
      </div>
    </div>
    <!-- Fin -->
    ...
    <!-- Fin -->
    <h3>EDITAR REPORTE DIARIO <?= strtoupper(FormatoFecha($fechaFormato)); ?></h3>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content" style="border-radius: 0px;border: 0px;">
        ...
        <div class="modal-header rounded-0 head-modal">
          <h4 class="modal-title text-white">Editar Fecha Actual</h4>

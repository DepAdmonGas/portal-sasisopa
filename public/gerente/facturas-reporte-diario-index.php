...
<html lang="es">
  ...
  <body>
    ...
    <div class="float-left"><h4>FACTURAS DE PRODUCTOS, <?=$idYear;?></h4></div>
    <div class="float-right">
    <a onclick="" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Buscar" >
    ...
    <div class="card-body">
      ...
      echo "<td class='align-middle text-center' width='20px' onclick='editarModal(".$idP.",1)'><img src='".RUTA_IMG_ICONOS."mas-verde-16.png' style='cursor: pointer;'></td>";
      echo "</tr>";
            ...
            <?php
              if ($Session_ProductoUno != "") {
               ...
               <div class='row'> ";
                ...
                echo "<div class='col-12 font-weight-bold  mb-2'>
                 $Session_ProductoUno 
                <hr></div>";
                ?>
              ...
              if ($Session_ProductoDos != "") {
               ...
               echo "<div class='col-12 font-weight-bold  mb-2'> $Session_ProductoDos                
               <hr></div>";
                ?>
              ...
              if ($Session_ProductoTres != "") {
               ...
               <div class='row'> ";
                ...
                echo "<div class='col-12 font-weight-bold  mb-2'> $Session_ProductoTres              
                <hr></div>";
                ?>

...
<div class="card-body">
<h5 class=""><?=nombremes($Mes).' '.$Year;?></h5>
 <div class="text-right mb-2"><button type="button" class="btn btn-info btn-sm rounded-0 text-white" onclick="Modal(<?=$idEstacion;?>)">+</button></div>

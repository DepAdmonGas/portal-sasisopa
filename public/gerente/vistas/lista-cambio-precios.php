...
$sql_precio = "SELECT * FROM tb_cambio_precio WHERE id_estacion = '".$Session_IDEstacion."' ORDER BY fecha desc";
...
while($row_precio = mysqli_fetch_array($result_precio, MYSQLI_ASSOC)){
	...
	$estado = "<img src='".RUTA_IMG_ICONOS."peligro-amarillo-16.png' title='Pendiente en actualizar'>";
	}else{
...
echo "<td class='text-center font font-weight-bold align-middle' width='20px'><img src='".RUTA_IMG_ICONOS."eliminar-red-16.png' onclick='BtnEliminar(".$row_precio['id'].",".$Session_IDEstacion.")'></td>";

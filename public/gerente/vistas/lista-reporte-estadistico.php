...
<a onclick="verdetalle(<?=$IDfecha;?>,<?=$idReporteCre; ?>)" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Ver detalle" >
<img src="<?php echo RUTA_IMG_ICONOS."ojo-black-16.png"; ?>">
</a>
</td>
<td width="20px" class="text-center align-middle">
<a onclick="editar(<?=$IDfecha;?>,<?=$idReporteCre; ?>)" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Editar" >
...
<div><span class="badge badge-pill badge-primary" id="totalMensajes" style="font-size: .5em;margin-right: -5px;"><?=$toMensajes;?></span><img src="<?php echo RUTA_IMG_ICONOS."mensaje-black-16.png"; ?>"></div>
</a>
</td>
</tr>
<?php

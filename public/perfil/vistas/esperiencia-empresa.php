...
if (FechaFin != "") {
  ...
  var parametros = {
    ...
    function(){
      ...
      $.ajax({
       data:  parametros,
       url:   'public/perfil/agregar/agregar-experiencia-empresa.php',
       type:  'post',
       beforeSend: function() {
...
function EliminarEE(id){
  ...
  function(){
    ...
    $.ajax({
     data:  parametros,
     url:   'public/perfil/eliminar/eliminar-experiencia-empresa.php',
     type:  'post',
     beforeSend: function() {
     },
     complete: function(){
...
<a class="float-right" onclick="ModalEE()" style="cursor: pointer;" data-toggle="tooltip" data-placement="right" title="Agregar"><img src="<?php echo RUTA_IMG_ICONOS."agregar.png"; ?>"></a>
</div>
...
<table class="table table-bordered table-striped table-sm" style="margin-top: 10px;font-size: 1.2em;">
  ...
  <tr>
    ...
    <th colspan="3" class="text-center">Periodo</th>
  </tr>
<tr>
    <th class="text-center">Inicio</th>
    <th class="text-center" colspan="2">Termino</th>
  </tr>
  </thead>
  ...
  echo "<td class='text-center'>".FormatoFecha($row_grupo['periodo_fin'])."</td>";

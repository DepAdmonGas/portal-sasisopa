...
$sql_comunicado = "SELECT * FROM se_comunicacion_i_e WHERE id_estacion = '".$Session_IDEstacion."' AND fecha BETWEEN '".$FechaInicio."' AND '".$FechaTermino."' ";
...
<td class="text-center align-middle">'.substr($row_comunicado['tema'],0,60).'</td>

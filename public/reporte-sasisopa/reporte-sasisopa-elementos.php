...
<meta charset="utf-8">
  ...
  <script type="text/javascript">
    ...
    //------1. POLÍTICA
    function Elemto1(FechaInicio, FechaTermino) {
      $('#Elemento1').load('../../public/reporte-sasisopa/sasisopa-elemento1.php?FechaInicio=' + FechaInicio + '&FechaTermino=' + FechaTermino);
    }

    function DescargarPolitica(id) {
    ...
    function Elemto2(FechaInicio, FechaTermino) {
      $('#Elemento2').load('../../public/reporte-sasisopa/sasisopa-elemento2.php?FechaInicio=' + FechaInicio + '&FechaTermino=' + FechaTermino);
    }
    ...
    function btnDescargarCDRL() {
      window.location = "../../descargar-control-documentos-rl";
    }

    function DescargarCDSA() {
    ...
    function DescargarEquipoCritico() {
 ...
 <div class="float-end">
    ...
    <div aria-label="breadcrumb" style="padding-left: 0; margin-bottom: 0;">
      <ol class="breadcrumb breadcrumb-caret">
        ...
        <li aria-current="page" class="breadcrumb-item active">REPORTE SASISOPA</li>
      </ol>
    </div>
    <!-- Fin -->

    <h3>REPORTE SASISOPA</h3>

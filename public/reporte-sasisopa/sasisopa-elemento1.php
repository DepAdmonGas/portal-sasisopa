...
?>
<a class="float-right" onclick="DescargarPolitica(<?=$Session_IDEstacion;?>)" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Descargar 1. Politica" >
Descargar politica <img src="<?php echo RUTA_IMG_ICONOS."pdf.png"; ?>">
</a>

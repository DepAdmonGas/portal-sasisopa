...
$sql_capacitacion = "SELECT tb_seguimiento_objetivos_metas.id,
tb_seguimiento_objetivos_metas.id_estacion,
tb_seguimiento_objetivos_metas_detalle.fecha,
tb_seguimiento_objetivos_metas_detalle.objetivo_meta,
tb_seguimiento_objetivos_metas_detalle.nivel_cumplimiento,
tb_seguimiento_objetivos_metas_detalle.medidas,
tb_seguimiento_objetivos_metas_detalle.fecha_aplicacion
FROM tb_seguimiento_objetivos_metas 
INNER JOIN tb_seguimiento_objetivos_metas_detalle 
ON tb_seguimiento_objetivos_metas.id = tb_seguimiento_objetivos_metas_detalle.id_seguimiento
WHERE tb_seguimiento_objetivos_metas.id_estacion = '".$Session_IDEstacion."' AND tb_seguimiento_objetivos_metas_detalle.fecha BETWEEN '".$FechaInicio."' AND '".$FechaTermino."' GROUP BY tb_seguimiento_objetivos_metas.id ORDER BY tb_seguimiento_objetivos_metas.id DESC ";
...
$dompdf->stream('Seguimiento de objetivos y metas.pdf',["Attachment" => true]);
//------------------
mysqli_close($con);
//------------------
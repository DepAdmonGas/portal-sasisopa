...
$sql = "SELECT * FROM tb_seguimiento_reporte_indicador WHERE id_estacion = '".$Session_IDEstacion."' AND fecha BETWEEN '".$FechaInicio."' AND '".$FechaTermino."' ";
...
$dompdf->stream('Seguimiento y reporte de indicadores.pdf',["Attachment" => true]);
//------------------
mysqli_close($con);
//------------------
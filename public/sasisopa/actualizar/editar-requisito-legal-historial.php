...
$ruta_a_file = "../../../archivos/reuisitos-legales/"."PDF-ACUSE-".$Session_IDEstacion."-".strtotime($hoy).".".$ext_acuse;
$ruta_rl_file = "../../../archivos/reuisitos-legales/"."PDF-REQUISITOL-".$Session_IDEstacion."-".strtotime($hoy).".".$ext_requisito;

if($acuse != "") {
$ruta_a = "archivos/reuisitos-legales/"."PDF-ACUSE-".$Session_IDEstacion."-".strtotime($hoy).".".$ext_acuse;
}else{
$ruta_a = "";
}

if($requisito != "") {
$ruta_rl = "archivos/reuisitos-legales/"."PDF-REQUISITOL-".$Session_IDEstacion."-".strtotime($hoy).".".$ext_requisito;
}else{
$ruta_rl = "";
}

...
$sql_val = "SELECT id_requisito_legal FROM rl_requisitos_legales_calendario WHERE id_estacion = '".$Session_IDEstacion."' AND id_requisito_legal = '".$_POST['requisitolegal']."' ";

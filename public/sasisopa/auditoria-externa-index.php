...
text-decoration:none !important;
  ...
  function ListaAuditoria(){
     ...
     $.ajax({
     url:   'public/sasisopa/buscar/buscar-lista-auditoria-externa.php',
     type:  'post',
     beforeSend: function() {
     },
     complete: function(){
...
var parametros = {
    ...
    "IdUsuario" : <?=$Session_IDUsuarioBD;?>
     ...
     $.ajax({
     data:  parametros,
     url:   'public/sasisopa/agregar/agregar-auditoria-externa.php',
     type:  'post',
     beforeSend: function() {
     },
     complete: function(){
...
function BTNArchivoIA(id){
  ...
  var url = 'public/sasisopa/agregar/agregar-archivo-formato24.php';
...
function BTNArchivoPAH(id){
 ...
 var ArchivoPdf = document.getElementById("ArchivoPdf");
  ...
  var data = new FormData();
  var url = 'public/sasisopa/agregar/agregar-archivo-formato25.php';
...
$.ajax({
data:  parametros,
url:   'public/sasisopa/buscar/buscar-detalle-asea.php',
type:  'post',
beforeSend: function() {
},
complete: function(){
...
$.ajax({
data:  parametros,
url:   'public/sasisopa/buscar/buscar-lista-asea.php',
type:  'post',
beforeSend: function() {
},
complete: function(){
...
$.ajax({
data:  parametros,
url:   'public/sasisopa/buscar/buscar-formulario-asea.php',
type:  'post',
beforeSend: function() {
},
complete: function(){
...
var data = new FormData();
var url = 'public/sasisopa/agregar/agregar-archivo-asea.php';

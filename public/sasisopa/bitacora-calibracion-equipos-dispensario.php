...
$UV = Detalle($GET_ID,'Unidad de verificacion',$con);
$NA = Detalle($GET_ID,'No. de acreditacion',$con);
...
<html lang="es">
  ...
  function EditarOtros(e,id,input){
    ...
    $.ajax({
 data:  parametros,
 url:   '../public/sasisopa/actualizar/editar-calibracion-equipos-dispensario.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
var parametros = {
    ...
    $.ajax({
 data:  parametros,
 url:   '../public/sasisopa/eliminar/eliminar-calibracion-equipos-dispensario.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
function(){
  ...
  $('#Modal').modal('show');
  $('#Contenido').load('../public/sasisopa/vistas/modal-agregar-dispensario-calibracion.php?id=' + ID + '&idestacion=' + idestacion);
  }
  ...
  var parametros = {
    ...
    $.ajax({
     data:  parametros,
     url:   '../public/sasisopa/agregar/agregar-calibracion-equipos-dispensario.php',
     type:  'post',
     beforeSend: function() {
     },
     complete: function(){

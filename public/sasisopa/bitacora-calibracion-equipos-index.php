...
<html lang="es">
  ...
  $('#ListaCalibracionEquipos').load('public/sasisopa/vistas/lista-calibracion-equipos.php');
  }

  function ModalAgregar(){
  $('#Modal').modal('show');
  $('#ContenidoModal').load('public/sasisopa/vistas/modal-agregar-calibracion-equipos.php');
  }
...
$.ajax({
 data:  parametros,
 url:   'public/sasisopa/agregar/agregar-calibracion-equipos.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
function(){
  ...
  $('#Modal').modal('show');
  $('#ContenidoModal').load('public/sasisopa/vistas/modal-detalle-calibracion-equipos.php?ID=' + id);
  }

  function ModalBuscar(){
  $('#Modal').modal('show');
  $('#ContenidoModal').load('public/sasisopa/vistas/modal-buscar-calibracion-equipos.php');
  }
  ...
  $('#Modal').modal('show');
  $('#ContenidoModal').load('public/sasisopa/vistas/modal-agregar-resultados-calibracion.php?ID=' + id);
  }

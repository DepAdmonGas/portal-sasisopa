...
$TA = Detalle($GET_ID,'Temperatura ambiente', $con);
$PA = Detalle($GET_ID,'Presión atmosférica', $con);
$H = Detalle($GET_ID,'Humedad', $con);
$LUC = Detalle($GET_ID,'Liquido usado en la calibración', $con);
$TL = Detalle($GET_ID,'Temperatura del líquido', $con);
$LC = Detalle($GET_ID,'Laboratorio de calibración', $con);
$NA = Detalle($GET_ID,'No. de acreditación', $con);
$MC = Detalle($GET_ID,'Método de calibración', $con);
...
<html lang="es">
  ...
  function EditarOtros(e,id,input){
    ...
    $.ajax({
 data:  parametros,
 url:   '../public/sasisopa/actualizar/editar-calibracion-equipos-jarra-patron.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){

...
<html lang="es">
  ...
  $('#idDetalleCategoria').load('public/sasisopa/vistas/categoria-bitacora-dispensario.php?Categoria=' + e.value);
  }
...
$.ajax({
 data:  parametros,
 url:   'public/sasisopa/agregar/agregar-dispensario-bitacora.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
$.ajax({
 data:  parametros,
 url:   'public/sasisopa/actualizar/editar-dispensario-bitacora.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
$('#ListaDispensario').load('public/sasisopa/vistas/lista-buscar-bitacora-dispensarios.php?selyear=' + selyear + '&selmes=' + selmes);
$('#ModalBuscar').modal('hide'); 
  ...
  function btnReporte(selyear,selmes){
  
  window.location = "reporte-bitacora-profeco/" + selyear + "/" + selmes; 
...
window.onblur = function() {
  ...
  <div class="LoaderPage"></div>
   ...
   <div class="float-left"><h4>Bitácora de registro de eventos PROFECO</h4></div>
    ...
    <a download href="public/sasisopa/vistas/reporte-excel-bitacora-dispensario.php" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Excel" >

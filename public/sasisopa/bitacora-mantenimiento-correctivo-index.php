...
window.location = "reporte-bitacora-mantenimiento/" + tipo; 
  ...
  <body>
    ...
    <div class="float-left"><h4>Mantenimiento Correctivo</h4></div>

    <div class="float-right">
<a class="ml-2" onclick="DescargarReporte('Correctivo')" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Decargar PDF" >
...
$sql_mantenimiento = "SELECT * FROM bi_mantenimientos WHERE id_estacion = '".$Session_IDEstacion."' AND categoria_mantenimiento = 'Correctivo' AND estado = 1 ORDER BY id desc";
...
$fechatermino = FormatoFecha($row_mantenimiento['fechaintermino']);

...
function MPendientes(){
   window.location.href = 'bitacora-mantenimiento-pendiente';
}
 function MPreventivo(){
  window.location.href = 'bitacora-mantenimiento-preventivo';
 }
 function MCorrectivo(){
  window.location.href = 'bitacora-mantenimiento-correctivo';
 }
 function MPredictivo(){
  window.location.href = 'bitacora-mantenimiento-predictivo';
      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mb-2">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary rounded-0 btn-sm ml-2 mb-2" onclick="MPendientes()">Pendientes</button>

            <button type="button" class="btn btn-success rounded-0 btn-sm ml-2 mb-2" onclick="MPreventivo()">Ver mantenimientos</button>
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mb-2 mt-2">
          ...
          <div class="card-body">
            ...
            <div class="text-right">
            <button type="button" class="btn btn-success rounded-0 btn-sm" onclick="MCorrectivo()">Ver mantenimientos</button>
            </div>
          </div>
        </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mb-2 mt-2">
          ...
          <div class="card-body">
           ...
           <hr>
            ...
            <div class="text-right">
            <button type="button" class="btn btn-success rounded-0 btn-sm" onclick="MPredictivo()">Ver mantenimientos</button>
            </div>
          </div>
        </div>
        </div>

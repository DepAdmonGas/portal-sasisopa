...
<html lang="es">
  ...
  <body>
    ...
    <div class="float-left"><h4>Mantenimiento Preventivo (Pendiente)</h4></div>
...
$sql_mantenimiento = "SELECT * FROM bi_mantenimientos WHERE id_estacion = '".$Session_IDEstacion."' AND categoria_mantenimiento = 'Preventivo' AND estado = 0 ORDER BY id desc";
...
echo '<div class="border shadow-sm p-2 c-pointer bg-light">';

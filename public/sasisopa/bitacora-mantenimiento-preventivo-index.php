...
<html lang="es">
  ...
  <body>
    ...
    <div class="float-left"><h4>Mantenimiento Preventivo</h4></div>

<div class="float-right">
<a class="ml-2" onclick="DescargarReporte('Preventivo')" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Decargar PDF" >
...
$sql_mantenimiento = "SELECT * FROM bi_mantenimientos WHERE id_estacion = '".$Session_IDEstacion."' AND categoria_mantenimiento = 'Preventivo' AND estado = 1 ORDER BY id desc";

...
<html lang="es">
  ...
  $('#DivDetelle').load('public/sasisopa/vistas/modal-crear-mantenimiento-quincenal.php');
  }
  ...
  var url = 'public/sasisopa/agregar/agregar-mantenimiento-quincenal.php';
...
$('#ContenidoMantenimiento').load('public/sasisopa/vistas/lista-mantenimeinto-quincenal.php')
}
...
function Eliminar(id){
  ...
  $.ajax({
   data:  parametros,
   url:   'public/sasisopa/eliminar/eliminar-bitacora-quincenal.php',
   type:  'post',
   beforeSend: function() {

...
function ConstRows($Session_ProductoUno,$Session_ProductoDos,$Session_ProductoTres,$Session_IDEstacion,$Year,$con){
...
$rows = ConstRows($Session_ProductoUno,$Session_ProductoDos,$Session_ProductoTres,$Session_IDEstacion,$Year,$con);

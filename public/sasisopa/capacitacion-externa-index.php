...
#Trabajadores{
  ...
  $('#ListaCursos').load('public/sasisopa/vistas/lista-capacitacion-externa.php');
  }

  function btnModal(){
  $('#ModalCapacitacion').modal('show');
  $('#Contenidomodal').load('public/sasisopa/vistas/formulario-agregar-capacitacion-externa.php');
  }
...
var parametros = {
   ...
   $.ajax({
   data:  parametros,
   url:   'public/sasisopa/agregar/agregar-capacitacion-externa.php',
   type:  'post',
   beforeSend: function() {
   },
   complete: function(){
...
function Editar(id){
$('#ModalCapacitacion').modal('show');
 $('#Contenidomodal').load('public/sasisopa/vistas/formulario-editar-capacitacion-externa.php?idCapacitacion=' + id);
}
...
var parametros = {
   ...
   $.ajax({
   data:  parametros,
   url:   'public/sasisopa/actualizar/editar-capacitacion-externa.php',
   type:  'post',
   beforeSend: function() {
   },
   complete: function(){
...
$('#ModalCapacitacion').modal('show'); 
$('#Contenidomodal').load('public/sasisopa/vistas/lista-personal-capacitacion-externa.php?idCapacitacion=' + id);
}
...
alertify.confirm('',
  function(){
   ...
   $.ajax({
   data:  parametros,
   url:   'public/sasisopa/eliminar/eliminar-personal-capacitacion-externa.php',
   type:  'post',
   beforeSend: function() {
   },
   complete: function(){
  ...
  $('#Contenidomodal').load('public/sasisopa/vistas/lista-personal-capacitacion-externa.php?idCapacitacion=' + idCapacitacion);
   }
   });
...
alertify.confirm('',
  function(){
   ...
   $.ajax({
   data:  parametros,
   url:   'public/sasisopa/agregar/agregar-personal-capacitacion-externa.php',
   type:  'post',
   beforeSend: function() {
   },
   complete: function(){
   ...
   success:  function (response) {
    var el = document.getElementById('Trabajadores');
...
alertify.confirm('',
  function(){
   ...
   $.ajax({
   data:  parametros,
   url:   'public/sasisopa/eliminar/eliminar-capacitacion-externa.php',
   type:  'post',
   beforeSend: function() {
   },
   complete: function(){

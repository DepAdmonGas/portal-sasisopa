...
<html lang="es">
  ...
  function ListaJarra(){
  $('#ListaJarra').load('public/sasisopa/vistas/lista-jarra-patron.php');
  }
...
$.ajax({
 data:  parametros,
 url:   'public/sasisopa/agregar/agregar-jarra-patron.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
$.ajax({
 data:  parametros,
 url:   'public/sasisopa/eliminar/eliminar-jarra-patron.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
function(){
  ...
  $('#DivEditar').load('public/sasisopa/vistas/modal-editar-jarra-patron.php?idJarra=' + id);
  }
...
let EditMaterial = $('#EditMaterial').val();
  ...
  if (EditCapacidad != "") {
          ...
          $.ajax({
          data:  parametros,
          url:   'public/sasisopa/actualizar/editar-jarra-patron.php',
          type:  'post',
          beforeSend: function() {
          },
          complete: function(){

...
<html lang="es">
  ...
  $('#ListaSondas').load('public/sasisopa/vistas/lista-sondas.php');
  }
...
$.ajax({
 data:  parametros,
 url:   'public/sasisopa/agregar/agregar-sonda-medicion.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
$.ajax({
 data:  parametros,
 url:   'public/sasisopa/eliminar/eliminar-sonda-medicion.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
...
function(){
  ...
  $('#DivEditar').load('public/sasisopa/vistas/modal-editar-sonda-medicion.php?idSonda=' + id);
  }
...
let EditUbicacion = $('#EditUbicacion').val();
  ...
  if (EditModelo != "") {
          ...
          $.ajax({
          data:  parametros,
          url:   'public/sasisopa/actualizar/editar-sonda-medicion.php',
          type:  'post',
          beforeSend: function() {
          },
          complete: function(){

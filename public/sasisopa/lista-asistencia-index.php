...
$sql_asistencia = "SELECT * FROM tb_lista_asistencia WHERE id = '".$GET_idRegistro."' ";
...
$.ajax({
 data:  parametros,
 url:   '../public/sasisopa/actualizar/actualizar-lista-asistencia.php',
 type:  'post',
 beforeSend: function() {
 },
 complete: function(){
  ...
  $('#PersonalFirma').css('border',''); 
   ...
   var parametros = {
    ...
    "PersonalFirma" : PersonalFirma
      ...
      $.ajax({
     data:  parametros,
     url:   '../public/sasisopa/agregar/agregar-lista-asistencia-firma.php',
     type:  'post',
     beforeSend: function() {
     },
     complete: function(){
...
$('#DivSelPersonal').load('../public/sasisopa/vistas/select-asistencia-personal.php?idReporte=' + id); 
}

  function ListaAsistencia(id){
$('#DivListaAsistencia').load('../public/sasisopa/vistas/lista-asistencia-firma.php?idReporte=' + id); 
}
...
function EliminarRegistro(idRegistro,id){
 ...
 $.ajax({
     data:  parametros,
     url:   '../public/sasisopa/eliminar/eliminar-lista-asistencia-firma.php',
     type:  'post',
     beforeSend: function() {
     },
     complete: function(){
  ...
  <body>
    ...
    <div class="font-weight-light mt-3">Dibuja la firma de la persona:</div>

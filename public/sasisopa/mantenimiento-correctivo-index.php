...
<html lang="es">
  ...
  $('#DivContenido').load('public/sasisopa/vistas/lista-mantenimiento-correctivo.php');    
  }
 
  function DetalleMantenimiento(id){
  $('#ModalDetalle').modal('show');
  $('#DivDetelle').load('public/sasisopa/vistas/modal-detalle-mantenimiento-correctivo.php?idMantenimiento=' + id);
  }
...
window.onblur = function() {
  ...
  $('#ModalDetalle').modal('show');
  $('#DivDetelle').load('public/sasisopa/vistas/modal-editar-mantenimiento-correctivo.php?idMantenimiento=' + idM);
  }
  ...
  var Herramienta = $('#Herramienta').val();
    ...
    $.ajax({
   data:  parametros,
   url:   'public/sasisopa/actualizar/actualizar-mantenimiento-correctivo.php',
   type:  'post',
   beforeSend: function() {
   },
   complete: function(){
  ...
  var url = 'public/sasisopa/agregar/agregar-evidencias-mantenimiento-correctivo.php';
...
data.append('FileEvidencia', FileEvidencia);
  ...
  function EliminarE(id,idM){
    ...
    $.ajax({
   data:  parametros,
   url:   'public/sasisopa/eliminar/eliminar-evidencia-mantenimiento-correctivo.php',
   type:  'post',
   beforeSend: function() {
   },
   complete: function(){
   ...
   $('#ModalDetalle').modal('show');
   $('#DivDetelle').load('public/sasisopa/vistas/modal-buscar-mantenimiento-correctivo.php');
  }
  ...
  var selmes = $('#selmes').val();
    ...
    $.ajax({
     data:  parametros,
     url:   'public/sasisopa/vistas/reporte-mantenimiento-correctivo.php',
     type:  'post',
     beforeSend: function() {

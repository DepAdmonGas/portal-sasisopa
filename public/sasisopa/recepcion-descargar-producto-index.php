...
<html lang="es">
  ...
  $('#Toltip').tooltip('hide')
  $('#DivContenido').load('public/sasisopa/vistas/lista-recepcion-descarga-producto.php');  
  }

  function DetalleRecepcion(id){
  $('#ModalDetalle').modal('show'); 
  $('#DetalleRecepcion').load('public/sasisopa/vistas/detalle-recepcion-descarga-producto.php?idRecepcion=' + id);   
  }
...
FinBusqueda();
 ...
 function FinBusqueda(){
  ...
  var selmes = $('#selmes').val();
    ...
    $.ajax({
     data:  parametros,
     url:   'public/sasisopa/vistas/reporte-recepcion-descarga-producto.php',
     type:  'post',
     beforeSend: function() {

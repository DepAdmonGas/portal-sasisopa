...
$sql_modulo = "SELECT fecha_programada, fecha_real, resultado, estado FROM tb_cursos_calendario WHERE id_personal = '".$idusuario."' AND id_tema = '".$idTema."' AND YEAR(fecha_programada) = '".$year."' ORDER BY fecha_programada ASC";
...
$dompdf->stream('Capacitación interna.pdf',["Attachment" => true]);
//------------------
mysqli_close($con);
//------------------
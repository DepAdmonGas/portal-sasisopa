...
$contenid0 .= '<div style="border: 1px solid rgba(0, 0, 0, 0.125);padding: 20px;">';
...
$contenid0 .= '<div style="border: 1px solid rgba(0, 0, 0, 0.125);padding: 20px;margin-top: 60px;border-bottom: 4px solid #005993;">

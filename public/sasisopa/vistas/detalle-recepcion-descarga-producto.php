...
$sql_tanque1 = "SELECT * FROM tb_recepcion_descargar_tanque WHERE id_recepcion_descarga = '".$idRecepcion."' AND idlista = '1' ";
...
$sql_tanque2 = "SELECT * FROM tb_recepcion_descargar_tanque WHERE id_recepcion_descarga = '".$idRecepcion."' AND idlista = '2' ";
...
$sql_tanque3 = "SELECT * FROM tb_recepcion_descargar_tanque WHERE id_recepcion_descarga = '".$idRecepcion."' AND idlista = '3' ";
...
$sql_tanque4 = "SELECT * FROM tb_recepcion_descargar_tanque WHERE id_recepcion_descarga = '".$idRecepcion."' AND idlista = '4' ";
...
$sql_imagen1 = "SELECT id_usuario,imagen_firma FROM tb_recepcion_descargar_firma WHERE id_recepcion_descarga = '".$idRecepcion."'  AND tipo_firma = 'FPR' ";
...
$sql_imagen2 = "SELECT id_usuario,imagen_firma FROM tb_recepcion_descargar_firma WHERE id_recepcion_descarga = '".$idRecepcion."'  AND tipo_firma = 'FPS' ";
...
$sql_merma = "SELECT * FROM tb_recepcion_descargar_tanque WHERE id_recepcion_descarga = '".$idRecepcion."' ";
...
//------------------------------------------------------------------------
$sql_verificar1 = "SELECT verificar, resultado FROM tb_recepcion_descargar_sellos WHERE id_recepcion_descarga = '".$idRecepcion."'  AND verificar = 'Se encuentran en buen estado' ";
...
$sql_verificar2 = "SELECT verificar, resultado FROM tb_recepcion_descargar_sellos WHERE id_recepcion_descarga = '".$idRecepcion."'  AND verificar = 'Sin rastro de sustancias aceitosas' ";
...
$sql_verificar3 = "SELECT verificar, resultado FROM tb_recepcion_descargar_sellos WHERE id_recepcion_descarga = '".$idRecepcion."'  AND verificar = 'Nivel del producto está a más de 1.5 cm (+/-0.3 cm)' ";

...
$sql_usuarios = "SELECT tb_usuarios.id, tb_usuarios.nombre, tb_usuarios.id_puesto, tb_usuarios.id_gas, tb_usuarios_firma_bitacora.id AS idFirma, tb_usuarios_firma_bitacora.categoria, tb_usuarios_firma_bitacora.estado
FROM tb_usuarios_firma_bitacora
INNER JOIN tb_usuarios on tb_usuarios.id = tb_usuarios_firma_bitacora.id_usuario
 WHERE id_gas = '".$Session_IDEstacion."' and categoria = '".$Categoria."' ";

...
<a class="ml-2" onclick="downloada('public/sasisopa/descargar-reporte-recepcion-descarga-producto.php?selyear=<?=$year?>&selmes=<?=$mes?>')" style="cursor: pointer;" data-toggle="tooltip" data-placement="left" title="Descargar PDF" >

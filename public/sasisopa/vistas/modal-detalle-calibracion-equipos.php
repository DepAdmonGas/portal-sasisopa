...
?>
  ...
  $UV = Detalle($_GET['ID'],'Unidad de verificacion',$con);
  $NA = Detalle($_GET['ID'],'No. de acreditacion',$con);
...
?>
  ...
  $TA = Detalle($_GET['ID'],'Temperatura ambiente', $con);
  $PA = Detalle($_GET['ID'],'Presión atmosférica', $con);
  $H = Detalle($_GET['ID'],'Humedad', $con);
  $LUC = Detalle($_GET['ID'],'Liquido usado en la calibración', $con);
  $TL = Detalle($_GET['ID'],'Temperatura del líquido', $con);
  $LC = Detalle($_GET['ID'],'Laboratorio de calibración', $con);
  $NA = Detalle($_GET['ID'],'No. de acreditación', $con);
  $MC = Detalle($_GET['ID'],'Método de calibración', $con);
...
?>
  ...
  $UV = Detalle($_GET['ID'],'Unidad de verificación', $con);
  $NA = Detalle($_GET['ID'],'No. de acreditación', $con);
  $MUC = Detalle($_GET['ID'],'Método usado para la calibración', $con);
  $Personal = Personal($IdUsuario,$con);
  ?>
